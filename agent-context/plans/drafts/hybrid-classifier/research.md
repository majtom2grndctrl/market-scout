...
Per posting: state ~1.3k tokens (median raw description 5.6k chars, less boilerplate), role pass 1 ~6k, pass 2 ~1.6k including the second state, specialization nouls ~8k (410 × ~20), skill nouls ~6k (~300 × ~20). Total ~23k tokens.
