...
```
!`ls agent-context/plans/drafts/`
```

Resolve to `agent-context/plans/drafts/<name>/index.md`.
...
- The relevant `agent-context/lib/` slices for subsystems the spec touches (route via `agent-context/lib/index.md`)
