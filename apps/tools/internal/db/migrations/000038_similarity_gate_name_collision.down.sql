-- Restore mcp.save_enrichment_unlocked to its 000034 definition, dropping the
-- mint-only `name_collision` check. Name-identical, slug-dissimilar terms mint
-- freely again, as they did before 000038. Nothing else in 000038 to undo: it
-- added no table, no index, and no grant.
