-- Keep current-row selection deterministic when two writes share a timestamp.
-- Replacing the display view preserves its interface and dependent taxonomy view.
